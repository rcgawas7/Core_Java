import java.util.Scanner;
	...
	class ProductDemo
	{
		...
		{	
			Product p1=new Product(1,3,100);
			Product p2=new Product(2,5,800);
			Product p3=new Product(3,2,600);
			Product p4=new Product(4,4,200);
			Product p5=new Product(5,7,500);
